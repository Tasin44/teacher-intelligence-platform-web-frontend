...
export default function ProfileAndFilter({
    ...
    return (
        <div className="bg-[#1E2130] p-6 rounded-xl border border-[#2A2D3A]" id="student-selector-card">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-[#0F1117] border border-[#2A2D3A] rounded-lg pl-10 pr-4 py-2.5 text-sm text-slate-100 focus:outline-none focus:border-orange-500 transition"
                    />
                    {searchQuery && (
            ...
            {/* Student Preview Bar */}
            <div className="mt-5 bg-[#FFF7ED] p-4 rounded-xl border border-[#2A2D3A]/60 flex flex-col sm:flex-row items-center justify-between gap-4" id="student-preview-bar">
