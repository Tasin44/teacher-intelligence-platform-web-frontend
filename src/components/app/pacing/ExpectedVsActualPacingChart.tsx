    ...
    return (
        <Card title='Expected vs Actual Pacing'>
            ...
            <div className="h-56 flex flex-col justify-between" id="visual-pacing-chart">
                <div className="flex-1 relative border-b border-slate-200 pb-2 flex overflow-hidden">
                    {/* Y Axis Labels */}
                    <div className="w-8 flex flex-col justify-between text-[11px] font-bold text-slate-450 select-none pb-5 pt-1 text-right pr-2 shrink-0">
                        <span>12</span>
                        <span>9</span>
                        <span>6</span>
                        <span>3</span>
                    ...
                    {/* Chart Bars Scrollable Wrapper */}
                    <div className="flex-1 overflow-x-auto w-full scrollbar-none">
                        <div className="relative flex justify-around items-end pb-5 pt-1 min-w-[380px] h-full">
                            ...
                            {data.map((week, idx) => {
                                ...
                                return (
                                    <div key={idx} className="flex flex-col items-center group w-12 text-center select-none z-10">
                                        ...
                                        <span className="absolute bottom-0 text-[10px] text-slate-400 font-semibold">
                                            {week.label}
                                        </span>
                                    </div>
                                );
